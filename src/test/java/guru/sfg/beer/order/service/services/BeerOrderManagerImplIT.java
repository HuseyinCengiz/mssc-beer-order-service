...
import guru.sfg.brewery.events.AllocationFailureEvent;
import guru.sfg.brewery.events.DeallocateOrderRequest;
...
public class BeerOrderManagerImplIT {
    ...
    void testNewToPickedUp() throws JsonProcessingException {
        ...
        Assertions.assertEquals(BeerOrderStatusEnum.PICKED_UP, pickedUpBeerOrder.getOrderStatus());
    }
    ...
    void testAllocationFailure() throws JsonProcessingException {
        ...
        Assertions.assertEquals(allocationFailureEvent.getOrderId(), savedBeerOrder.getId());
    }
    ...
    void testAllocatedToCancel() throws JsonProcessingException {
        ...
        Assertions.assertEquals(deallocateOrderRequest.getBeerOrder().getId(), savedBeerOrder.getId());
    }
